    ...
    public class XuLyFile {
        public static void taoThuMuc(String path) {
            ...
            if (!file.exists()) { // exists => kiểm tra đã tồn tại hay chưa?
                ...
                file.mkdir(); // tạo nhiều thư mục cùng lúc
            } else {
...
//                }
        ...
        public static void main(String[] args) {
             String path = "C:\\Users\\Trand\\Desktop\\Học\\LapTrinhMang\\NewFile";
             XuLyFile.taoThuMuc(path);

            // String path = "C:\\Users\\Trand\\Desktop\\Học\\LapTrinhMang\\File1";
            // XuLyFile.taoThuMuc(path);

            // String path = "C:\Users\\Trand\\Desktop\\Học\LapTrinhMang\\BAITAP.DOCX";
            // XuLyFile.taoTapTin(path);

            // String path = "C:\\Users\\rand\\Desktop\\Học\\LapTrinhMang\\BAITAP.DOCX";
            // XuLyFile.taoTapTin(path);

            //String path = "C:\\Users\\Trand\\Desktop\\Học\\LapTrinhMang\\BAITAP.DOCX";
            //XuLyFile.xoa(path);

            //String path = "C:\\Users\\Trand\Desktop\\Học\\LapTrinhMang\\temp - Copy";
            //XuLyFile.xoa(path);
